...
namespace Reefact.LuxaforDevicesController.UnitTests {
    ...
    public class UsageExamples {
        ...
        private static class MyCommand {
            ...
            public static readonly LightingCommand SetAllYellow       = LightingCommand.CreateSetColorCommand(BrightColor.Yellow);
            public static readonly LightingCommand StrobeYellow       = LightingCommand.CreateStrobeCommand(TargetedLeds.All, BrightColor.Yellow, Speed.FromByte(20), Repeat.Count(3));
            public static readonly LightingCommand SetAllMagenta      = LightingCommand.CreateSetColorCommand(BrightColor.Magenta);
            public static readonly LightingCommand SetBackSideMagenta = LightingCommand.CreateSetColorCommand(TargetedLeds.BackSide, BrightColor.Magenta);
            public static readonly LightingCommand SetTabSideMagenta  = LightingCommand.CreateSetColorCommand(TargetedLeds.TabSide, BrightColor.Magenta);
